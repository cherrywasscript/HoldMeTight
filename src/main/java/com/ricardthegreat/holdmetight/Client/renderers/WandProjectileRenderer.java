...
public class WandProjectileRenderer extends EntityRenderer<WandProjectile> {
    ...
    public void render(WandProjectile p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_,
    ...
    @Override
    public ResourceLocation getTextureLocation(WandProjectile p_115371_) {
