package com.ricardthegreat.unnamedsizemod.Client.renderers;
...
public class RayGunProjectileRenderer extends EntityRenderer<RayGunProjectile> {
    ...
    private static final ResourceLocation RAY_PROJECTILE_LOCATION = new ResourceLocation(
            "textures/entity/ray_gun_projectile.png");
    //private final LlamaSpitModel<LlamaSpit> model;

    public RayGunProjectileRenderer(EntityRendererProvider.Context p_174296_) {
        super(p_174296_);
        //this.model = new LlamaSpitModel<>(p_174296_.bakeLayer(ModelLayers.LLAMA_SPIT));
    }

    public void render(LlamaSpit p_115373_, float p_115374_, float p_115375_, PoseStack p_115376_,
