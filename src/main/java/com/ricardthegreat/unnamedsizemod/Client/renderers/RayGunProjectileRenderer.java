...
import com.ricardthegreat.unnamedsizemod.Client.models.RayGunProjectileModel;
...
public class RayGunProjectileRenderer extends EntityRenderer<RayGunProjectile> {
    ...
    private static final ResourceLocation RAY_PROJECTILE_LOCATION = new ResourceLocation(UnnamedSizeMod.MODID, "textures/entity/ray_gun_projectile.png");
